...
def download_raw(limit: Optional[int] = None, destination: str = './data/'):
...
if __name__ == "__main__":
    ...
    ranked_dataset_samples = "./ranked_dataset_samples.json"
    ranked_all_samples = "./ranked_complete_samples.json"
    slice_size = 256
    num_files = 2048
    dataset_size = 100_000

    download_raw(limit=num_files, destination=data_dir)
    ...
    save_file_list(files_by_entropy, ranked_all_samples)
    save_file_list(files_by_entropy[:dataset_size], ranked_dataset_samples)
